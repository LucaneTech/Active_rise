...
import { Globe, Megaphone, Users, FileText } from 'lucide-react';
...
export default function Communication() {
  ...
  const services = [
    { icon: Globe, title: t('services.communication.s1'), description: t('services.communication.s1_desc') },
    { icon: FileText, title: t('services.communication.s2'), description: t('services.communication.s2_desc') },
    { icon: Megaphone, title: t('services.communication.s3'), description: t('services.communication.s3_desc') },
    { icon: Users, title: t('services.communication.s4'), description: t('services.communication.s4_desc') },
  ];
    ...
    <div className="min-h-screen bg-beige overflow-hidden">
      ...
      `,
        ...
        <div className="container-xl relative z-10">
          ...
          >
            {t('services.communication.title')} <span className="text-gold">{t('services.communication.title2')}</span>
          </motion.h1>
          <motion.p
