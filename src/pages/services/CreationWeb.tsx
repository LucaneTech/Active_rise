...
import { Code2, Video, Camera, Star } from 'lucide-react';
...
export default function CreationWeb() {
  ...
  const services = [
    { icon: Code2, title: t('services.web.s1'), description: t('services.web.s1_desc') },
    { icon: Star, title: t('services.creation.s1'), description: t('services.creation.s1_desc') },
    { icon: Video, title: t('services.creation.s3'), description: t('services.creation.s3_desc') },
    { icon: Camera, title: t('services.creation.s5'), description: t('services.creation.s5_desc') },
  ];
