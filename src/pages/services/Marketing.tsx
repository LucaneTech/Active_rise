...
import { Target, Mail, FileText, Users, ArrowRight } from 'lucide-react';
...
export default function Marketing() {
  ...
  const services = [
    { icon: Target, title: t('services.marketing.s1'), description: t('services.marketing.s1_desc') },
    { icon: Mail, title: t('services.marketing.s2'), description: t('services.marketing.s2_desc') },
    { icon: FileText, title: t('services.marketing.s3'), description: t('services.marketing.s3_desc') },
    { icon: Users, title: t('services.marketing.s4'), description: t('services.marketing.s4_desc') },
  ];
    ...
    <div className="min-h-screen bg-beige overflow-hidden">
      ...
      `,
        ...
        <div className="container-xl relative z-10">
          ...
          >
            {t('services.marketing.title')} <span className="text-gold">{t('services.marketing.title2')}</span>
          </motion.h1>
          <motion.p
