...
export default function Marketing() {
  ...
  const intro = t('services.marketing.intro', { defaultValue: '' });
  const formation = t('services.marketing.formation', { returnObjects: true }) as { title: string; description: string; } || { title: '', description: '' };
  const cta = t('services.marketing.cta', { returnObjects: true }) as { title: string; title2: string; text: string; btn: string; } || { title: '', title2: '', text: '', btn: '' };
    ...
    <div className="min-h-screen bg-[#0A0A0C] text-[#F3F4F6] selection:bg-gold selection:text-black antialiased overflow-x-hidden font-sans">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-6 pt-32 pb-24 sm:px-8 lg:pt-44 lg:pb-36 flex flex-col justify-center">
        ...
        >
          ...
          >
            {t('services.marketing.eyebrow', { defaultValue: 'PERFORMANCE & GROWTH' })}
          </motion.p>
          ...
          >
            <span className="block text-white opacity-95">{t('services.marketing.title')}</span>
      ...
      <section id="explore" className="mx-auto w-full max-w-7xl px-6 py-16 sm:px-8 border-t border-white/[0.04]">
        <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <span className="text-xs font-semibold uppercase tracking-widest text-gold/80">{t('services.marketing.sections_label')}</span>
            <h2 className="mt-2 text-3xl font-bold uppercase tracking-tight text-white sm:text-4xl">{t('services.marketing.sections_title')}</h2>
          </div>
          ...
          >
            ...
            <div className="max-w-3xl">
              <span className="text-xs font-bold uppercase tracking-widest text-gold/80 flex items-center gap-2 mb-2">
                <span className="w-1.5 h-1.5 bg-gold rounded-full" /> {t('services.marketing.formation_label')}
              </span>
      ...
      <section id="conversion" className="mx-auto w-full max-w-7xl px-6 py-16 sm:px-8 mb-20">
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <div className="pt-6">
              <a
                href="/contact" // High-converting localized target framework pipeline
