    ...
    <section className="section-padding bg-beige dark:bg-deep">
      <div className="container-xl">
        <div className="text-center mb-16">
          {badge && (
            <RevealOnScroll delay={0}>
              <span className="inline-flex items-center gap-2 text-xs font-semibold tracking-[0.2em] uppercase text-gold border border-gold/30 px-4 py-2 rounded-md mb-6">
          ...
          <RevealOnScroll delay={0.1}>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-deep ">
        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-px bg-gold" />
