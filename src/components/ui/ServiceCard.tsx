  ...
  return (
    <RevealOnScroll delay={delay} direction="up">
      <motion.div
        ...
        className="group relative p-7 h-full flex flex-col overflow-hidden shadow-lg border border-gray-500/30 rounded-md  transition-shadow duration-300 "
      >
        ...
        {/* Icon */}
        <div className="relative w-11 h-11 rounded-md bg-gold flex items-center justify-center mb-5 group-hover:bg-gold/18 transition-colors duration-300 ">
