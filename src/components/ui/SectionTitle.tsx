    ...
    <div className={`flex flex-col gap-3.5 ${centerClass}`}>
      {badge && (
        <RevealOnScroll delay={0}>
          <span className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-[0.18em] uppercase text-gold shadow-badge px-4 py-1.5 rounded-full">
            {/* Small decorative circle */}
            <span className="relative flex w-1.5 h-1.5">
              <span className="absolute inline-flex w-full h-full rounded-full bg-gold opacity-40 animate-ping" style={{ animationDuration: '2.4s' }} />
