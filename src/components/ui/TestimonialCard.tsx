  ...
  return (
    <RevealOnScroll delay={delay} direction="up">
      <motion.div
        ...
        className="relative glass-card rounded-2xl p-7 h-full flex flex-col overflow-hidden shadow-[0_2px_20px_rgba(0,0,0,0.18)] hover:shadow-[0_4px_32px_rgba(211,170,42,0.10)] transition-shadow duration-300 border border-beige/[0.07]"
      >
        {/* Stars */}
